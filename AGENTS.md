...
- 当前设置链路为：`settings.js -> preload.js -> main.js -> settings-store.js -> Electron userData/settings.json -> CCMonitor`。
...
Issue #6 已完成收尾，当前本地位于与 `origin/main` 同步的 `main`，没有遗留功能分支。开始下一项工作前，应先读取 GitHub 未关闭 Issue 的最新状态和优先级，再从最新 `main` 创建独立短分支。
